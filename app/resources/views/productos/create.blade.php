...
@section('content')
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
        <div>
            ...
            <p class="text-muted mb-0">Complete el formulario para registrar un producto en el inventario</p>
        </div>
    </div>

    {{-- Formulario de creación --}}
    {{-- Integrar con: action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" --}}
            ...
            <form action="{{ url('/productos') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="row g-3 g-md-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        ...
                        {{-- Integrar con: @foreach($categorias as $categoria) --}}
