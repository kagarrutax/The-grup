...
@section('page-subtitle', 'Gestiona tu cuenta personal')
                ...
                <div class="card-body p-0">
                    ...
                    <div class="profile-body p-4">
                        ...
                        <div class="profile-actions d-flex gap-3 flex-wrap">
                            ...
                            <button class="btn btn-outline-danger" onclick="showDeleteConfirmation('{{ $user->name }}', '{{ route('profile.destroy') }}', 'cuenta de usuario')">
                ...
                <div class="card-body">
                    ...
                    <div class="account-options">
                        ...
                        <div class="option-item">
                            ...
                            <div class="option-action">
                                <button class="btn btn-sm btn-outline-danger" onclick="showDeleteConfirmation('{{ $user->name }}', '{{ route('profile.destroy') }}', 'cuenta de usuario')">
                                    <i class="bi bi-arrow-right"></i>
                                </button>
                            </div>
                        </div>
